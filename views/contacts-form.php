            ...
            <?php if (isset($_GET['status']) && $_GET['status'] === 'success' && isset($_SESSION['client_name'], $_SESSION['client_code'])) : ?>
                ...
                <form action="../includes/clients.inc.php" method="post">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="client_name" name="client_name" value="<?php echo htmlspecialchars($_SESSION['client_name']); ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="disabledTextInput" class="form-label">Client Code</label>
                        <input type="text" id="disabledTextInput" class="form-control" value="<?php echo htmlspecialchars($_SESSION['client_code']); ?>" readonly>
                    </div>
